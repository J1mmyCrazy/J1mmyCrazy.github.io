...
fn tint_symbol_2_inner(tint_symbol_3 : vec3u) {
  ...
  textureStore(tint_symbol_1, x_17, vec4f((floor((x_22.x * 7.0f)) / 11.0f), (floor((x_22.y * 7.0f)) / 7.0f), (floor((x_22.z * 7.0f)) / 9.0f), x_22.w));
  return;
}

fn tint_symbol_2_1() {
  let x_50 = tint_symbol_3_1;
  tint_symbol_2_inner(x_50);
  return;
}
