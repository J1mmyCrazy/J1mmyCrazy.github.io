...
fn tint_symbol_25_inner(tint_symbol_26 : vec3u) {
  ...
  if ((x_158 < arrayLength(&(tint_symbol_12.inner)))) {
    ...
    x_169 = tint_ftou(x_172);
    let x_175 = tint_symbol_27.tint_symbol_7.y;
    x_173 = tint_ftou(x_175);
    let x_177 = tint_symbol_10.inner[x_169].tint_symbol_1;
    let x_179 = tint_symbol_10.inner[x_173].tint_symbol_1;
    x_182 = tint_symbol_10.inner[x_169].tint_symbol_4;
    x_184 = tint_symbol_10.inner[x_173].tint_symbol_4;
    x_185 = (x_179 - x_177);
    let x_186 = length(x_185);
    x_192 = (tint_symbol_27.tint_symbol_9 * (x_186 - tint_symbol_27.tint_symbol_8));
    if ((x_186 > 0.00000099999999747524f)) {
      let x_197 = normalize(x_185);
      let x_199 = (x_182 * 1000.0f);
      if ((x_199 > 0.00000099999999747524f)) {
        tint_symbol_11.inner[x_169].tint_symbol_3 = (tint_symbol_11.inner[x_169].tint_symbol_3 + ((x_197 * x_192) / vec2f(x_199)));
      }
      let x_211 = (x_184 * 1000.0f);
      if ((x_211 > 0.00000099999999747524f)) {
        tint_symbol_11.inner[x_173].tint_symbol_3 = (tint_symbol_11.inner[x_173].tint_symbol_3 - ((x_197 * x_192) / vec2f(x_211)));
      }
    }
  }
  return;
...
fn tint_symbol_43_inner(tint_symbol_26_3 : vec3u) {
  let x_230 = tint_symbol_26_3.x;
  if ((x_230 < arrayLength(&(tint_symbol_10.inner)))) {
    let x_236 = tint_symbol_10.inner[x_230];
    if ((x_236.tint_symbol_5 != 1.0f)) {
      tint_symbol_11.inner[x_230].tint_symbol_1 = ((x_236.tint_symbol_1 + x_236.tint_symbol_2) + tint_symbol_11.inner[x_230].tint_symbol_3);
      tint_symbol_11.inner[x_230].tint_symbol_2 = ((x_236.tint_symbol_2 + tint_symbol_11.inner[x_230].tint_symbol_3) * 0.94999998807907104492f);
    } else {
      tint_symbol_11.inner[x_230].tint_symbol_1 = x_236.tint_symbol_1;
      tint_symbol_11.inner[x_230].tint_symbol_2 = x_236.tint_symbol_2;
    }
    tint_symbol_11.inner[x_230].tint_symbol_3 = vec2f();
    tint_symbol_11.inner[x_230].tint_symbol_4 = x_236.tint_symbol_4;
    tint_symbol_11.inner[x_230].tint_symbol_5 = x_236.tint_symbol_5;
  }
  if ((x_230 == 20u)) {
    tint_symbol_11.inner[x_230].tint_symbol_2 = (tint_symbol_11.inner[x_230].tint_symbol_2 + vec2f(0.0f, -0.00100000004749745131f));
  }
  return;
}

fn tint_symbol_43_1() {
  let x_279 = tint_symbol_26_2;
  tint_symbol_43_inner(x_279);
  return;
}
